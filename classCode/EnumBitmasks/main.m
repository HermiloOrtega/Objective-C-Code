...
void isCEOOrPromgramer(Position pos) {
  if (pos & PositionCEO)            printf("CEO\n");
  if (pos & PositionProgrammer)     printf("Programmer\n");
  if (pos & PositionDesigner)       printf("Designer\n");
  if (pos & PositionHumanResource)  printf("HumanResource\n");
  if (pos & PositionProjectManager) printf("ProjectManager\n");
  if (pos & PositionScrumMaster)    printf("ScrumMaster\n");
  if (pos & PositionTester)         printf("Tester\n");
}
...
int main(int argc, const char * argv[]) {
    @autoreleasepool {
        ...
        switch (type) {
            case VideoGameTypeRPG:      printf("RPG\n");        break;
            case VideoGameTypeStrategy: printf("Strategy\n");   break;
            case VideoGameTypeAction:   printf("Action\n");     break;
            case VideoGameTypeFPS:      printf("FPS\n");        break;
            case VideoGameTypeSports:   puts("Sports");         break;
        }
    }
    return 0;
}
